...
public class CitationRemovedEventTest extends EventTest {
    private CitationRemovedEvent cae;
    private Date t0;
    private String msg;
    ...
    public void runBefore() {
        ...
        cae = new CitationRemovedEvent(fullCitation, citation);

        t0 = Calendar.getInstance().getTime();
        msg = String.format("Citation of type %s(ID %s) is removed from %s(ID %s)", citation.getClass(),
